                ...
                <tr key={item.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-xs sm:text-[13px] text-gray-500">
                    <div className='flex flex-col gap-y-1'>
                        <p className='text-black font-medium'>{item.reportedBy}</p>
                        <p className='text-[11px] sm:text-xs'>Report Date: {item.reportedDate}</p>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-xs sm:text-[13px] text-gray-500">
                    <div className='flex flex-col gap-y-1'>
                        <p className='text-black font-medium'>{item.assignedCompany}</p>
                        <p className='text-[11px] sm:text-xs'>Pickup Date: {item.pickupTime}</p>
                    </div>
                  </td>
