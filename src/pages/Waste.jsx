...
const Waste = () => {
    ...
    return <>
        ...
        <div className="flex flex-col xs:flex-row justify-between  sm:mx-20 bg-white mb-10 border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4  px-4 sm:px-20 mb-20">
            <div className="flex flex-col gap-y-4 shadow-sm rounded-md border border-gray-100 p-4">
