  ...
  return <>
    <div className="flex justify-between items-center mb-6 gap-y-6 flex-wrap">
      <div className="leftInventoryHeading flex flex-col gap-1 flex-wrap">
          ...
          <p className="text-gray-500 text-xs sm:text-[13px]"> {kanban ? "View Information on wastes you have approved for today" : "View your history of wastes you've picked up"}</p>
      </div>
      {
        kanban ?
